    ...
    <ul class="divide-y divide-slate-100 sm:hidden">
      <li v-for="(r, index) in items" :key="r.id" class="flex flex-col gap-3 p-4">
        ...
        <div class="grid grid-cols-2 gap-x-3 gap-y-1.5 text-[13px]">
          ...
          <div>
            <span class="text-[11px] font-semibold uppercase tracking-wide text-slate-400">Duration</span>
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3.5 text-center">
              <span class="inline-flex min-w-[48px] items-center justify-center rounded-md bg-slate-100 px-2.5 py-1 text-xs font-bold text-slate-600">
