...
import { CheckCircle2, XCircle, Ban, Clock3, MessageCircle, AtSign, UserSearch } from 'lucide-vue-next'
...
const iconStyle = computed(() => {
  switch (props.notification.type) {
    ...
    case 'leave_under_review':
      return { icon: UserSearch, bg: 'bg-cyan-100', text: 'text-cyan-600' }
